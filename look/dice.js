...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-0723a1ed');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-0723a1ed');}
...
var brandEl=document.querySelector('.rl-brand-0723a1ed');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
